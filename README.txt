...
2) We have submitted two .html files, namely Final_With_Code.html and Final_Without_Code.html, and each of them has a corresponding folder of other files necessary for the HTML to load correctly.
The purpose of this is so that the marker can view our project with the input blocks(code) either hidden or showing.